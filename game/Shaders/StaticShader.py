...
class StaticShader:
    ...
    def get_uniform_locations(self):
        ...
        uniforms['fake_lightning_loc'] = glGetUniformLocation(self.program, "useFakeLightning")
        return uniforms
    ...
    def load_shine(self, tex_model):
        glUniform1fv(self.uniforms['shine_damp_loc'], 1, tex_model.shine_damp)
        glUniform1fv(self.uniforms['reflectivity_loc'], 1, tex_model.reflectivity)
